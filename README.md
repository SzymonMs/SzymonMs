...
- 🔭 Currently, I have finished work on a game console project in the scientific circle of robotics, automation and computer science KN RAI. I am currently working in the KUKA youBot project in the same circle. Its purpose is to create a vision system for a robot that will collect objects placed in the room. I will keep you updated on the progress of work. I am also in the electronics science and PLC club KN SENSOR all the time. I am also involved in the design of the DC and stepper motor control station. It is a partial project before the final work at the university. In the near future I will also create my own Android application, create new small projects and update my old repositories.
- 🌱 I’m currently learning many different fields of electronics, programming of STM32 microcontrollers, PLC, AI and ML, python,Kotlin, control theory and system identification, drivers, BMS and others.
